...
const TOOL_OUTPUT_SCHEMAS: Record<string, object> = {"validate-data":{"input":{"type":"http","method":"POST","bodyFields":{"data":{"type":"string","description":"The JSON data to validate","required":true},"schema":{"type":"object","description":"JSON Schema to validate against","required":true}}},"output":null},"generate-hash":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to hash","required":true},"algorithm":{"type":"string","enum":["sha256","sha512","md5","sha1"],"description":"(default: sha256)"}}},"output":null},"qr-code":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text or URL to encode","required":true},"size":{"type":"integer","description":"Image size in pixels (default: 200)"},"format":{"type":"string","enum":["png","svg"],"description":"(default: png)"}}},"output":null},"convert-format":{"input":{"type":"http","method":"POST","bodyFields":{"input":{"type":"string","description":"The content to convert (serialized as a string)","required":true},"from":{"type":"string","description":"Source format","required":true,"enum":["json","yaml","csv","xml","toml"]},"to":{"type":"string","description":"Target format","required":true,"enum":["json","yaml","csv","xml","toml"]}}},"output":null},"transform-text":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to transform","required":true},"mode":{"type":"string","description":"Transformation mode","required":true,"enum":["slug","camel","snake","pascal","kebab","upper","lower","title","base64_encode","base64_decode"]}}},"output":null},"extract-metadata":{"input":{"type":"http","method":"POST","bodyFields":{"url":{"type":"string","description":"URL to extract metadata from"},"text":{"type":"string","description":"Raw text to analyze (alternative to url)"}}},"output":null},"web-scrape":{"input":{"type":"http","method":"POST","bodyFields":{"url":{"type":"string","description":"URL to scrape","required":true},"format":{"type":"string","enum":["markdown","html","text"],"description":"(default: markdown)"},"selector":{"type":"string","description":"CSS selector to extract specific element"}}},"output":null},"extract-page":{"input":{"type":"http","method":"POST","bodyFields":{"url":{"type":"string","description":"URL of the webpage to extract","required":true},"include_links":{"type":"boolean","description":"Include extracted links (default: True)"}}},"output":null},"search-web":{"input":{"type":"http","method":"POST","bodyFields":{"query":{"type":"string","description":"Search query","required":true},"limit":{"type":"integer","description":"(default: 10)"}}},"output":null},"rss-parse":{"input":{"type":"http","method":"POST","bodyFields":{"url":{"type":"string","description":"RSS or Atom feed URL","required":true},"limit":{"type":"integer","description":"Maximum number of items to return (default: 20)"}}},"output":null},"ip-lookup":{"input":{"type":"http","method":"POST","bodyFields":{"ip":{"type":"string","description":"IP address (uses caller's IP if omitted)"}}},"output":null},"whois-lookup":{"input":{"type":"http","method":"POST","bodyFields":{"domain":{"type":"string","description":"Domain name to look up (e.g. example.com)","required":true}}},"output":null},"email-verify":{"input":{"type":"http","method":"POST","bodyFields":{"email":{"type":"string","description":"Email address to verify","required":true}}},"output":null},"phone-validate":{"input":{"type":"http","method":"POST","bodyFields":{"phone":{"type":"string","description":"Phone number to validate","required":true},"country":{"type":"string","description":"ISO 3166-1 alpha-2 country code (e.g. US, GB)"}}},"output":null},"currency-convert":{"input":{"type":"http","method":"POST","bodyFields":{"amount":{"type":"number","description":"Amount to convert","required":true},"from":{"type":"string","description":"Source currency code (e.g. USD, EUR, GBP)","required":true},"to":{"type":"string","description":"Target currency code (e.g. EUR, JPY, BTC)","required":true}}},"output":null},"timezone-convert":{"input":{"type":"http","method":"POST","bodyFields":{"datetime":{"type":"string","description":"ISO 8601 datetime to convert (e.g. 2024-01-15T14:30:00)","required":true},"from_tz":{"type":"string","description":"Source IANA timezone (e.g. America/New_York)","required":true},"to_tz":{"type":"string","description":"Target IANA timezone (e.g. Europe/London)","required":true}}},"output":null},"generate-uuid":{"input":{"type":"http","method":"POST","bodyFields":{"type":{"type":"string","description":"Type of identifier to generate (default: uuid)","enum":["uuid","token","api-key"]},"count":{"type":"integer","description":"Number of identifiers to generate (default: 1)"},"length":{"type":"integer","description":"Length for token/api-key types (default: 32)"}}},"output":null},"diff-text":{"input":{"type":"http","method":"POST","bodyFields":{"text1":{"type":"string","description":"Original text","required":true},"text2":{"type":"string","description":"Modified text","required":true},"mode":{"type":"string","description":"Diff output format (default: unified)","enum":["unified","words","chars","json"]}}},"output":null},"readability-score":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to analyze for readability","required":true}}},"output":null},"language-detect":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to detect the language of","required":true}}},"output":null},"sentiment-analysis":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to analyze","required":true}}},"output":null},"summarize":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to summarize","required":true},"style":{"type":"string","description":"Summary style (default: bullets)","enum":["bullets","tldr","executive","paragraph","headline"]},"max_length":{"type":"integer","description":"Maximum summary length in words"}}},"output":null},"extract-entities":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to extract entities from","required":true}}},"output":null},"regex-generate":{"input":{"type":"http","method":"POST","bodyFields":{"description":{"type":"string","description":"Plain English description of the pattern to match","required":true},"test_strings":{"type":"array","description":"Optional strings to test the generated regex against"}}},"output":null},"pii-detect":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to scan for PII","required":true},"redact":{"type":"boolean","description":"Whether to return redacted version of the text (default: False)"}}},"output":null},"web-search":{"input":{"type":"http","method":"POST","bodyFields":{"query":{"type":"string","description":"Search query","required":true},"limit":{"type":"integer","description":"Number of source results (default: 5)"}}},"output":null},"ai-generate":{"input":{"type":"http","method":"POST","bodyFields":{"prompt":{"type":"string","description":"The prompt or question","required":true},"model":{"type":"string","description":"AI model to use (default: claude)","enum":["claude","gpt4","grok","gemini"]},"system":{"type":"string","description":"System prompt / persona"},"max_tokens":{"type":"integer","description":"(default: 1024)"}}},"output":null},"ocr-extract":{"input":{"type":"http","method":"POST","bodyFields":{"image_url":{"type":"string","description":"Public URL of the image"},"image_base64":{"type":"string","description":"Base64-encoded image (alternative to image_url)"}}},"output":null},"browser-task":{"input":{"type":"http","method":"POST","bodyFields":{"url":{"type":"string","description":"Starting URL for the browser session","required":true},"steps":{"type":"array","description":"Sequence of browser actions to execute","required":true}}},"output":null},"extract-pdf":{"input":{"type":"http","method":"POST","bodyFields":{"pdf_url":{"type":"string","description":"Public URL of the PDF"},"pdf_base64":{"type":"string","description":"Base64-encoded PDF (alternative to pdf_url)"}}},"output":null},"screenshot-capture":{"input":{"type":"http","method":"POST","bodyFields":{"url":{"type":"string","description":"URL to screenshot","required":true},"width":{"type":"integer","description":"Viewport width in pixels (default: 1280)"},"height":{"type":"integer","description":"Viewport height in pixels (default: 800)"},"full_page":{"type":"boolean","description":"Capture full scrollable page (default: False)"},"format":{"type":"string","enum":["png","jpeg"],"description":"(default: png)"}}},"output":null},"html-to-markdown":{"input":{"type":"http","method":"POST","bodyFields":{"html":{"type":"string","description":"HTML content to convert","required":true},"url":{"type":"string","description":"URL to fetch and convert (alternative to html)"}}},"output":null},"url-shorten":{"input":{"type":"http","method":"POST","bodyFields":{"url":{"type":"string","description":"Long URL to shorten","required":true}}},"output":null},"webhook-send":{"input":{"type":"http","method":"POST","bodyFields":{"webhook_url":{"type":"string","description":"The webhook endpoint URL to POST to","required":true},"payload":{"type":"object","description":"JSON body to send in the POST request","required":true},"headers":{"type":"object","description":"Optional custom headers to include"},"method":{"type":"string","enum":["GET","POST","PUT","PATCH","DELETE"],"description":"(default: POST)"}}},"output":null},"jsonpath-query":{"input":{"type":"http","method":"POST","bodyFields":{"data":{"type":"object","description":"The JSON object to query","required":true},"path":{"type":"string","description":"JSONPath expression, e.g. $.store.book[*].title","required":true}}},"output":null},"image-generate":{"input":{"type":"http","method":"POST","bodyFields":{"prompt":{"type":"string","description":"Image description / prompt","required":true},"size":{"type":"string","enum":["1024x1024","1792x1024","1024x1792"],"description":"(default: 1024x1024)"},"style":{"type":"string","enum":["vivid","natural"],"description":"(default: vivid)"}}},"output":null},"barcode-generate":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text or number to encode","required":true},"format":{"type":"string","description":"Barcode format (default: CODE128)","enum":["CODE128","EAN13","UPC","CODE39","ITF14"]},"width":{"type":"integer","description":"Bar width (default: 2)"},"height":{"type":"integer","description":"Bar height in pixels (default: 100)"}}},"output":null},"workflow-agent":{"input":{"type":"http","method":"POST","bodyFields":{"goal":{"type":"string","description":"High-level goal for the workflow agent","required":true},"tools":{"type":"array","description":"List of tool names the agent can use"},"max_steps":{"type":"integer","description":"Maximum number of steps the agent can take (default: 5)"}}},"output":null},"crypto-price":{"input":{"type":"http","method":"POST","bodyFields":{"symbol":{"type":"string","description":"CoinGecko coin ID (e.g. bitcoin, ethereum, solana)","required":true}}},"output":null},"crypto-ohlcv":{"input":{"type":"http","method":"POST","bodyFields":{"symbol":{"type":"string","description":"CoinGecko coin ID (e.g. bitcoin, ethereum)","required":true},"days":{"type":"integer","description":"Number of days of OHLCV data (1, 7, 14, 30, 90, 180, 365) (default: 7)"}}},"output":null},"crypto-market-cap":{"input":{"type":"http","method":"POST","bodyFields":{"limit":{"type":"integer","description":"Number of top coins to return (default: 10)"},"currency":{"type":"string","description":"Fiat currency for prices (default: usd)"}}},"output":null},"crypto-fear-greed":{"input":{"type":"http","method":"POST","bodyFields":{"limit":{"type":"integer","description":"Number of historical entries (1 = current) (default: 1)"}}},"output":null},"crypto-sentiment":{"input":{"type":"http","method":"POST","bodyFields":{"symbol":{"type":"string","description":"CoinGecko coin ID (e.g. bitcoin, ethereum)","required":true}}},"output":null},"crypto-news":{"input":{"type":"http","method":"POST","bodyFields":{"symbol":{"type":"string","description":"Filter by coin symbol (e.g. BTC, ETH)"},"limit":{"type":"integer","description":"(default: 10)"}}},"output":null},"token-lookup":{"input":{"type":"http","method":"POST","bodyFields":{"query":{"type":"string","description":"Token name or ticker to search (e.g. bitcoin, BTC, solana)","required":true}}},"output":null},"ai-oracle":{"input":{"type":"http","method":"POST","bodyFields":{"question":{"type":"string","description":"Question or topic to analyze","required":true},"context":{"type":"string","description":"Additional context for the analysis"},"depth":{"type":"string","description":"Analysis depth level (default: standard)","enum":["quick","standard","deep"]}}},"output":null},"session-create":{"input":{"type":"http","method":"POST","bodyFields":{"system":{"type":"string","description":"System prompt for the session"},"model":{"type":"string","description":"AI model to use (default: claude)","enum":["claude","gpt4","grok","gemini"]},"ttl":{"type":"integer","description":"Session time-to-live in seconds (default: 3600)"}}},"output":null},"session-message":{"input":{"type":"http","method":"POST","bodyFields":{"session_id":{"type":"string","description":"Session ID from session-create","required":true},"message":{"type":"string","description":"User message to send","required":true}}},"output":null},"text-to-speech":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Text to convert (max 5,000 chars)","required":true},"voice_id":{"type":"string","description":"ElevenLabs voice ID (default: EXAVITQu4vr4xnSDxMaL)"},"model_id":{"type":"string","description":"ElevenLabs model ID (default: eleven_turbo_v2_5)"},"stability":{"type":"number","description":"Voice stability 0-1 (default: 0.42)"},"similarity_boost":{"type":"number","description":"Voice similarity boost 0-1 (default: 0.82)"}}},"output":null},"transcribe-audio":{"input":{"type":"http","method":"POST","bodyFields":{"audio_url":{"type":"string","description":"Public URL of the audio file (MP3, WAV, M4A, OGG)","required":true},"language":{"type":"string","description":"ISO-639-1 language code (auto-detected if omitted)"},"prompt":{"type":"string","description":"Context hint for better accuracy"}}},"output":null},"email-send":{"input":{"type":"http","method":"POST","bodyFields":{"to":{"type":"string","description":"Recipient email address","required":true},"subject":{"type":"string","description":"Email subject line","required":true},"body":{"type":"string","description":"Plain text email body","required":true},"html":{"type":"string","description":"HTML email body (alternative to body)"},"from":{"type":"string","description":"Sender (default: no-reply@archtools.dev)"}}},"output":null},"design-create":{"input":{"type":"http","method":"POST","bodyFields":{"prompt":{"type":"string","description":"Image description","required":true},"size":{"type":"string","enum":["1024x1024","1792x1024","1024x1792"],"description":"(default: 1024x1024)"},"quality":{"type":"string","enum":["standard","hd"],"description":"(default: standard)"},"style":{"type":"string","enum":["vivid","natural"],"description":"(default: vivid)"}}},"output":null},"domain-check":{"input":{"type":"http","method":"POST","bodyFields":{"domain":{"type":"string","description":"Domain name (e.g. example.com)","required":true}}},"output":null},"news-search":{"input":{"type":"http","method":"POST","bodyFields":{"query":{"type":"string","description":"News search query","required":true},"limit":{"type":"integer","description":"Maximum number of articles to return (default: 10)"},"language":{"type":"string","description":"ISO-639-1 language code (default: en)"}}},"output":null},"research-report":{"input":{"type":"http","method":"POST","bodyFields":{"topic":{"type":"string","description":"Research topic or question","required":true},"depth":{"type":"string","description":"Report depth level (default: standard)","enum":["brief","standard","comprehensive"]},"format":{"type":"string","enum":["markdown","json"],"description":"(default: markdown)"}}},"output":null},"fact-check":{"input":{"type":"http","method":"POST","bodyFields":{"claim":{"type":"string","description":"The claim or statement to verify","required":true},"context":{"type":"string","description":"Additional context about the claim"}}},"output":null},"video-generate":{"input":{"type":"http","method":"POST","bodyFields":{"prompt":{"type":"string","description":"Text description of the video to generate","required":true},"duration":{"type":"integer","description":"Video duration in seconds (4 or 10) (default: 4)"}}},"output":null},"image-remove-bg":{"input":{"type":"http","method":"POST","bodyFields":{"image_url":{"type":"string","description":"Public URL of the image"},"image_base64":{"type":"string","description":"Base64-encoded image (alternative to image_url)"},"size":{"type":"string","description":"Output size (default: auto)","enum":["preview","full","auto"]}}},"output":null},"email-find":{"input":{"type":"http","method":"POST","bodyFields":{"domain":{"type":"string","description":"Company domain (e.g. google.com)","required":true},"first_name":{"type":"string","description":"Person's first name"},"last_name":{"type":"string","description":"Person's last name"}}},"output":null},"semantic-search":{"input":{"type":"http","method":"POST","bodyFields":{"query":{"type":"string","description":"Natural language search query","required":true},"num_results":{"type":"integer","description":"Number of results to return (default: 10)"},"include_text":{"type":"boolean","description":"Include full page text in results (default: True)"}}},"output":null},"social-post":{"input":{"type":"http","method":"POST","bodyFields":{"text":{"type":"string","description":"Tweet text (max 280 characters)","required":true},"reply_to":{"type":"string","description":"Tweet ID to reply to"}}},"output":null}};
...
function buildPaymentRequired(toolName: string, price: string): object {
  ...
  if (nearWallet) {
    ...
    if (nearPriceFloat <= 0.002)       yoctoNear = "250000000000000000000";   // 0.00025 NEAR ~$0.001
    else if (nearPriceFloat <= 0.005)  yoctoNear = "750000000000000000000";
    else if (nearPriceFloat <= 0.010)  yoctoNear = "1500000000000000000000";
    else if (nearPriceFloat <= 0.020)  yoctoNear = "3000000000000000000000";
    else                               yoctoNear = "6000000000000000000000";
  ...
  if (solBaseWallet) {
    const solPriceFloat = parseFloat(price);
    let solAtomic: string;
    if (solPriceFloat <= 0.002)       solAtomic = "7000";    // 0.000007 SOL ~$0.001
    else if (solPriceFloat <= 0.005)  solAtomic = "17000";
    else if (solPriceFloat <= 0.010)  solAtomic = "35000";
    else if (solPriceFloat <= 0.020)  solAtomic = "70000";
    else                               solAtomic = "140000";
  ...
  if (taoWallet) {
    ...
    let taoRao: string;
    if (taoPriceFloat <= 0.002)       taoRao = "2500";    // 0.0000025 TAO ~$0.001
    else if (taoPriceFloat <= 0.005)  taoRao = "6250";
    else if (taoPriceFloat <= 0.010)  taoRao = "12500";
    else if (taoPriceFloat <= 0.020)  taoRao = "25000";
    else                               taoRao = "62500";
  ...
  if (toolSchema) {
    for (const accept of accepts) {
      (accept as Record<string, unknown>).outputSchema = toolSchema;
    }
  }
  ...
  const filteredAccepts = accepts
    ...
    .filter((a: any) => X402SCAN_VALID_NETWORKS.has(a.network));
