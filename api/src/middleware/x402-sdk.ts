...
function buildSdkRoutes(): Record<string, { accepts: { scheme: string; price: string; network: string; payTo: string; maxTimeoutSeconds?: number }; description: string }> {
  ...
  const routes: Record<string, { accepts: { scheme: string; price: string; network: string; payTo: string; maxTimeoutSeconds?: number }; description: string }> = {};
