...
<head>
  ...
  <meta name="description" content="64 AI-powered API tools for developers and AI agents. Scrape, generate, convert, detect, and more. One API key. 100 free credits on signup — 25 instant, 75 on email verify. No credit card required." />
...
<section class="hero">
  ...
  <div class="hero-inner">
    <div class="hero-badge">
      ...
      Now live · 63 production tools · 100 free credits (25 instant, 75 on email verify) · No credit card required
    </div>
  ...
  <div class="steps">
    <div class="step">
      ...
      <div>
        ...
        <div class="step-desc">Enter your email at <a href="/signup" style="color:var(--text);text-decoration:underline">/signup</a> — your API key is generated instantly. 25 free credits usable right away, 75 more on email verification (100 total, refreshed monthly).</div>
      </div>
    </div>
    <div class="step">
...
<section class="section">
  ...
  <div class="payment-grid">
    ...
    <div class="payment-card">
      ...
      <div class="payment-desc">x402 protocol support on Base and Polygon. AI agents pay per-call autonomously with USDC — no human required.</div>
      <div class="payment-detail">Pay-per-call via x402 HTTP protocol</div>
      <div class="payment-detail">Base + Polygon networks</div>
...
<section class="section" id="pricing">
  ...
  <p class="section-sub">Every account gets 100 free credits — 25 instant on signup, 75 more on email verify; no card required, no trial expiry.
  ...
  <div class="pricing-grid">
    <div class="plan-card">
      ...
      <ul class="plan-features">
        ...
        <li>100 free credits (25 instant, 75 on email verify)</li>
      </ul>
