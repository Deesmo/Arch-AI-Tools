...
<head>
  ...
  <meta name="description" content="64 AI-powered API tools for developers and AI agents. Scrape, generate, convert, detect, and more. One API key. 100 free credits on signup — 10 instant, 90 on email verify. No credit card required." />
  ...
  <div class="steps">
    <div class="step">
      ...
      <div>
        ...
        <div class="step-desc">Enter your email at <a href="/signup" style="color:var(--text);text-decoration:underline">/signup</a> — your API key is generated instantly. 10 free credits usable right away, 90 more on email verification (100 total, refreshed monthly).</div>
      </div>
    </div>
    <div class="step">
...
<section class="section" id="pricing">
  ...
  <p class="section-sub">Every account gets 100 free credits — 10 instant on signup, 90 more on email verify; no card required, no trial expiry.
