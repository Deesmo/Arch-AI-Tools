 ...
 * 
 * Exposes all 63 Arch Tools endpoints as MCP actions.
...
const ARCH_TOOLS: ArchTool[] = [
  ...
  { name: "summarize", description: "Summarize text (bullets, TLDR, executive, paragraph)", price: "$0.010",
  ...
  { name: "research-report", description: "Generate comprehensive research report", price: "$0.055",
  ...
  { name: "fact-check", description: "Verify a claim using multiple sources", price: "$0.020",
  ...
  { name: "image-generate", description: "Generate SVG images from text prompts", price: "$0.030",
  ...
  { name: "screenshot-capture", description: "Capture screenshot of any URL", price: "$0.010",
  ...
  { name: "transcribe-audio", description: "Transcribe audio with Whisper", price: "$0.030",
  ...
  { name: "ocr-extract", description: "Extract text from images (OCR)", price: "$0.015",
    inputSchema: { type: "object", properties: { image_url: { type: "string" }, image_base64: { type: "string" } } } },
  { name: "email-verify", description: "Verify email validity and deliverability", price: "$0.010",
    inputSchema: { type: "object", properties: { email: { type: "string" } }, required: ["email"] } },
  { name: "email-find", description: "Find email for person at company", price: "$0.120",
  ...
  { name: "language-detect", description: "Detect language of text", price: "$0.010",
    inputSchema: { type: "object", properties: { text: { type: "string" } }, required: ["text"] } },
  { name: "pii-detect", description: "Detect and redact PII", price: "$0.010",
  ...
  { name: "workflow-agent", description: "Multi-step AI agent chaining tools autonomously", price: "$0.025",
    inputSchema: { type: "object", properties: { goal: { type: "string" }, tools: { type: "array" }, max_steps: { type: "integer" } }, required: ["goal"] } },
  { name: "ai-oracle", description: "Deep AI analysis (quick/standard/deep modes)", price: "$0.025",
