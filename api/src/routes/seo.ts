...
const CTA = `<div style="background:#1e293b;border:1px solid #334155;border-radius:12px;padding:24px;margin-top:32px;text-align:center">
  ...
  <p style="color:#94a3b8;margin:0 0 16px;font-size:14px">Access all 64 tools programmatically. Get 100 free credits — 10 instant, 90 on email verify; no credit card required.</p>
