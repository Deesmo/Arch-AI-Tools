...
router.get("/servers/search", (req: Request, res: Response): void => {
...
router.post("/servers/submit", (req: Request, res: Response): void => {
...
router.get("/servers/:id", (req: Request, res: Response): void => {
