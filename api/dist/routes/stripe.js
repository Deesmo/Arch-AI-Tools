 ...
 */
stripeRouter.post("/v1/checkout", requireApiKey, async (req, res) => {
    ...
    try {
        ...
        const client = new stripe(stripeKey, { apiVersion: "2024-06-20" });
...
stripeRouter.post("/stripe/webhook", async (req, res) => {
    ...
    if (secret && sig) {
        try {
            ...
            event = client.webhooks.constructEvent(req.rawBody || JSON.stringify(req.body), sig, secret);
        }
        catch (e) {
