...
openApiRouter.get("/openapi.json", (_req, res) => {
    ...
    res.json({
        ...
        info: {
            ...
            version: "1.0.0",
            description: "Production-ready API tools for developers and AI agents. Discover tools, authenticate agents, invoke tools, and purchase credits via Stripe.",
        ...
        components: {
            securitySchemes: {
                bearerAuth: {
                    ...
                    description: "Use the agent API key from POST /v1/agent/register as `Authorization: Bearer <api_key>`.",
                },
            },
            schemas: {
                ErrorResponse: {
