...
// ─── Shared HTML layout ───
function layout(title, body, accentColor = "#FF9010") {
    return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export async function sendEmail80PctAlert(to, creditsRemaining, agentId) {
...
export async function sendCreditsDepletedAlert(to, agentId) {
